...
export const approveSuggestedEdit = async (knowledge: typeof faqs.$inferSelect, content?: string) => {
...
export const rejectSuggestedEdit = async (knowledge: typeof faqs.$inferSelect) => {
  await db.transaction(async (tx) => {
